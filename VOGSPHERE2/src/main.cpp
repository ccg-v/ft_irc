...
/*
	Minimum length (8): Avoids weak passwords.
	Maximum length (32): Prevents buffer overflows or excessive size.
	Printable characters only: Avoids control characters that could break input processing.
	No spaces: Ensures password is treated as a single argument.
*/
